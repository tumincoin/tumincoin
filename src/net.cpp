...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "tumincoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"tumincoin.org", "dnsseed1.tumincoin.org"},
    {"tumincoin.org", "dnsseed2.tumincoin.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"tumincoin.org", "testnet-seed1.tumincoin.org"},
    {"tumincoin.org", "testnet-seed1.tumincoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. tumincoin is probably already running."), addrBind.ToString().c_str());
        else
